...
function addLetter() {
    ...
    chooseCheckbox.addEventListener("click", open);
    ...
    var newChooseCheckbox = document.querySelector('.letter__choose');
...
function open() {
    var curr = document.getElementById('letter__choose');
    ...
    for (var i = 0; i < chooseCheckboxes.length; i++) {
        if (chooseCheckboxes[i].checked) {
            var parent = chooseCheckboxes[i].parentElement;
            if (parent == prevOpened) {
                return;
            }
            prevOpened = parent;
            curr.removeAttribute('id');
            chooseCheckboxes[i].setAttribute('id', 'letter__choose');
            return;
        }
    }
}

var allChooseCheckboxes = document.querySelectorAll('.letter__choose');
for (var i = 0; i < allChooseCheckboxes.length; i++) {
